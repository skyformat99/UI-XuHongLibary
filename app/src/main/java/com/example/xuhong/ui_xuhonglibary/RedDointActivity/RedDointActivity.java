package com.example.xuhong.ui_xuhonglibary.RedDointActivity;
...
public class RedDointActivity extends BaseActivity {

    private TextView textview, tv_offsetx, tv_padding, tv_offsety, tv_numbersize, tv_dragstate;
    private EditText et_badgenumber, et_badgetext;
    private ImageView imageview, iv_badgecolor, iv_numbercolor;
    private Button button, btn_animation;
    private List<RadioButton> radioButtons = new ArrayList<>();
    private CompoundButton lastRadioButton;
    private SeekBar seekBar_offsetx, seekBar_padding, seekBar_offsety, seekBar_numbersize;
    private Switch swicth_exact, swicth_draggable, swicth_shadow;
    private List<Badge> badges;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_red_doint);
        initView();
        initListener();
        initBadge();
    ...
    private void selectorColor(final OnColorClickListener l) {
        ...
        gv.setAdapter(new BaseAdapter() {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                View v = new View(RedDointActivity.this);
                ...
                WindowManager wm = (WindowManager) RedDointActivity.this
