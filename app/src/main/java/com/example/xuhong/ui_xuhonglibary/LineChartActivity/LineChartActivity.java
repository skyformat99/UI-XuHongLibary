package com.example.xuhong.ui_xuhonglibary.LineChartActivity;
...
/*
 *  项目名：  UI-XuHongLibary 
 *  包名：    com.example.xuhong.ui_xuhonglibary.LineChartActivity
 *  文件名:   LineChartActivity
 *  创建者:   XuHong
 *  创建时间:  2017/2/14 16:00
 *  描述：    TODO
 */
public class LineChartActivity extends BaseActivity implements OnChartGestureListener, OnChartValueSelectedListener, View.OnClickListener {
    ...
    private void initView() {
        ...
        values2.add(new Entry(8, 50));
        values2.add(new Entry(12, 66));
        values2.add(new Entry(10, 120));
        values2.add(new Entry(55, 30));
        values2.add(new Entry(45, 10));
        values2.add(new Entry(46, 110));
        values2.add(new Entry(75, 30));
        values2.add(new Entry(40, 160));
        values2.add(new Entry(60, 30));
    ...
    private void setData(ArrayList<Entry> values,ArrayList<Entry> values2) {
        if (mLineChar.getData() != null && mLineChar.getData().getDataSetCount() > 0) {
            ...
            // 创建一个数据集,并给它一个类型
            set1 = new LineDataSet(values, "采集报告");
            // 在这里设置线
            ...
            // 在这里设置线
            set2 = new LineDataSet(values, "温度采集");
