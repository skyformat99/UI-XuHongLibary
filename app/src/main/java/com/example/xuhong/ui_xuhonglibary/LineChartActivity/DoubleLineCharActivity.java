...
public class DoubleLineCharActivity extends BaseActivity implements OnChartValueSelectedListener, View.OnClickListener {
    ...
    private void initView() {
        ...
        //基本控件
        btn_show_values = (Button)
                findViewById(R.id.btn_show_values);
        ...
        description.setText("采集报告");
        description.setTextColor(Color.RED);
        mDoubleLineChar.getDescription().setEnabled(true);
        mDoubleLineChar.setDescription(description);
    ...
    private void setData(int count, float range) {
        ...
        if (mDoubleLineChar.getData() != null &&
            ...
            //创建一个数据集,并给它一个类型
            set2 = new LineDataSet(yVals2, "血糖");
            set1.isDrawValuesEnabled();
            ...
            set3 = new LineDataSet(yVals3, "尿酸");
...
//        labels2.add("June");
//
//        LineData lineData = new LineData(labels, labels2);
